      ...
      <div className="admin-cards">
        <div className="admin-card">
          ...
          <div className="admin-card-actions">
            <Link to="/admins/events/create" className="admin-btn primary">Create New Event</Link>
            <Link to="/admins/events" className="admin-btn secondary">View All Events</Link>
          </div>
        </div>
        ...
        <div className="admin-card">
          ...
          <div className="admin-card-actions">
            <Link to="/admins/users" className="admin-btn secondary">View Users</Link>
          </div>
        </div>
